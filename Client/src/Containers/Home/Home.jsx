  ...
  return (
   <section className='h-full'>
    ...
    <div className='flex justify-between w-128 mx-auto items-cetrer p-10'>
        ...
        <div className='mt-8'>
        <h1 className='font-martian  text-4xl w-96 text-white'>Robust <span className=' text-midnight'>Legal AI Assistance</span> at Your Service.
          <span className=' text-metal'>24/7</span>
        </h1>
        <Button text="START CHAT" styles="mt-8  bg-gradient-to-r from-midnight to-metal rounded-3xl  border-metal font-bold shadow-md px-10 py-4 text-white w-128"/>
